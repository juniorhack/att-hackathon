# [#atthack](https://twitter.com/hashtag/atthack?f=tweets&vertical=default&src=hash) || #atthack2025
...
* [Raspberry Pi 3 + 5](https://github.com/juniorhack/att-hackathon/blob/master/raspberry.md)
  ...
  * [Explorer pHAT](https://github.com/juniorhack/att-hackathon/blob/master/raspberry.md#explorer-phat)


* [ESP32 - LILYGO, Pycom](https://github.com/juniorhack/att-hackathon/blob/master/esp32.md)
...
For tutorial links and datasheets for some of our sensors, please see following page with [details](https://github.com/juniorhack/att-hackathon/blob/master/sensors.md)  
...
* check our [details page](https://github.com/juniorhack/att-hackathon/blob/master/sensors.md) for description of the sensors and basic documentation  
